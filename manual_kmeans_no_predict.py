...
def PCA():
    ...
    standardize() 
    standardized_rows = len(standardized_data)
    ...
    cov_applied = np.dot(centered_vals-standardized_mean[:, None],(centered_vals-standardized_mean[:, None]).T)/standardized_rows
